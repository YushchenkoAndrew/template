...
$("body").terminal(
  {
    ...
    cat: (fileName) => {
      ...
      if (fileName.includes("png") || fileName.includes("jpg")) {
        $.getJSON("Terminal/FileStructure.json", (data) => $.terminal.active().echo($(`<img src="${fileName}">`))).fail(() =>
    ...
    ls: () => {
      ...
      $.getJSON("Terminal/FileStructure.json", (data) => {
        let list = [];
    ...
    run: (url) => {
      ...
      $.getJSON("Terminal/FileStructure.json", (data) => (window.location = data[url] ? `../${url}` : url));
    },
    ...
    help: (flag) => {
      ...
      $.getJSON("Terminal/Help.json", (data) => {
    ...
    func: () => {
      ...
      $.getJSON("Terminal/FuncList.json", (data) => {
